  ...
  try {
    ...
    const sanitizeObject = (obj) => {
      if (typeof obj === 'string') {
        // SKIP sanitization for base64 images and large data payloads (performance & corruption fix)
        if (obj.startsWith('data:image/') || obj.includes(';base64,') || obj.length > 10000) {
          return obj;
        }
        return xss(obj);
      }
